...
class BorrowingsTest < ApplicationSystemTestCase
  ...
  test "should create borrowing" do
    ...
    fill_in "Book title", with: @borrowing.book_title
    fill_in "Borrowed at", with: @borrowing.borrowed_at
    fill_in "Returned at", with: @borrowing.returned_at
    fill_in "User", with: @borrowing.user_id
    fill_in "User name", with: @borrowing.user_name
  ...
  test "should update Borrowing" do
    ...
    fill_in "Book", with: @borrowing.book_id
    fill_in "Book title", with: @borrowing.book_title
    fill_in "Borrowed at", with: @borrowing.borrowed_at.to_s
    fill_in "Returned at", with: @borrowing.returned_at.to_s
    fill_in "User", with: @borrowing.user_id
    fill_in "User name", with: @borrowing.user_name
